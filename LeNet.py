...
def create_model(input_shape, weight=1e-3):
	...
	# Conv1
    x = Conv1D(32, kernel_size=10, strides=2, padding="valid", activation="relu", kernel_initializer="he_normal",
               kernel_regularizer=l2(weight), bias_regularizer=l2(weight))(inputs)
    x = MaxPooling1D(pool_size=2, strides=2)(x)

	# Conv2
    x = Conv1D(64, kernel_size=10, strides=2, padding="valid", activation="relu", kernel_initializer="he_normal",
